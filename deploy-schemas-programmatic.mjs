...
async function generateConsolidatedSql() {
  ...
  const aiSchema = readFileSync('./database/ai-schema.sql', 'utf8');
...
`;
  ...
  writeFileSync('./database/DEPLOY_THIS_TO_SUPABASE.sql', consolidatedSql);
...
async function createMigrationFiles() {
  ...
  const migrationContent = readFileSync('./database/ai-schema.sql', 'utf8');
