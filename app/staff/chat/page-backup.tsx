  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex h-[calc(100vh-48px)] relative">
        ...
        <div className="hidden lg:block w-80 bg-white border-r flex-shrink-0 h-full">
        ...
        {/* Mobile Sidebar */}
        <div className={`${showSidebar ? 'translate-x-0' : '-translate-x-full'} lg:hidden fixed top-0 bottom-0 left-0 z-50 w-80 bg-white border-r transition-transform duration-300 ease-in-out h-full`}>
          <div className="flex flex-col h-full">
            {/* Sidebar Header */}
            <div className="p-4 border-b">
              <div className="flex items-center justify-between mb-4">
