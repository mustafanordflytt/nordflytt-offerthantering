  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex h-[calc(100vh-48px)]">
        ...
        {/* Sidebar */}
        <div className={`${showSidebar ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:relative top-0 lg:top-auto bottom-0 lg:bottom-auto left-0 z-50 w-80 bg-white border-r transition-transform duration-300 ease-in-out lg:block flex-shrink-0 h-full`}>
