-- NORDFLYTT SCHEMA DEPLOYMENT - SAFE ORDER
...
-- Step 3: Create all base tables FIRST (before any ALTER commands)
...
-- Step 4: NOW add missing columns to existing tables (after they're created)
ALTER TABLE inventory_items ADD COLUMN IF NOT EXISTS category VARCHAR(100);

-- Step 5: Create dependent tables (ones with foreign keys)
