...
async function checkMariaBooking() {
  ...
  try {
    ...
    const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://dbevjdoatbsciclkqvqe.supabase.co';
    const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRiZXZqZG9hdGJzY2ljbGtxdnFlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjQ0MjI5MjUsImV4cCI6MjA0MDAwODkyNX0.XBTBdueRWFqn0YHGVvhH5pVEQl_dDJBAb5qY-cs0LHo';
